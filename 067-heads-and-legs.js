...
// Return a tuple in Python - (Heads, Legs) and an array list - [Heads,
// Legs]/{Heads, Legs} in all other languages
...
// INVALID - [72, 201] => "No solutions" However, if 0 heads and 0 legs are
// given always return [0, 0] since zero heads must give zero animals.
...
function animals(heads, legs){
  ...
  let checkCows = cows >= 0 && Number.isInteger(cows);
  let chickens = heads - cows;
  let checkChickens = chickens >= 0 && Number.isInteger(chickens);
  return checkChickens && checkCows ? [chickens, cows] : "No solutions";
}
