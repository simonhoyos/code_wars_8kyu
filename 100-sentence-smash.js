...
// var words = ['hello', 'world', 'this', 'is', 'great']; smash(words);
// returns "hello world this is great" 

// Assumptions

// You can assume that you are only given words. You cannot assume the size of
// the array. You can assume that you do get an array. What We're Testing
...
// This is for beginners so we want to test basic loops and string
// manipulation. Advanced users should easily be able to do this in one line.
