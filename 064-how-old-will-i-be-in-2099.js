...
// various years in the future such as 2090 or 3044. His parents can't keep up
...
// courious every day he may soon want to know how many years it was until he
...
// year(s) old." For dates in the past: "You will be born in ... year(s)." If
// the year of birth equals the year requested return: "You were born this
// very year!"

// "..." are to be replaced by the number, followed and proceeded by a single
// "..." space. Mind that you need to account for both "year" and "years",
...
function  calculateAge(y1, y2) {
  let dif = y2 - y1;
  let year = dif == 1 || dif == -1 ? "year" : "years";
  if (y1 < y2) {
    return `You are ${dif} ${year} old.`
  } else if (y2 < y1) {
    return `You will be born in ${-dif} ${year}.`
  } else {
