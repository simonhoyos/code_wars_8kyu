...
// check if the user is still alive called checkAlive. Unfortunately, Greg
// made some errors while creating the function.

// checkAlive should return true if the player's health is greater than 0 or
